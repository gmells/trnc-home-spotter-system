...
export default function CreateProperty() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (+formData.standardPrice < +formData.discountedPrice) {
        return setError("Discounted price must be lesser than Standard price");
      }
      setLoading(true);
      setError(false);
        ...
        <div className="flex flex-col flex-1 gap-4">
          <p className="font-semibold">
            ...
            <span className="font-normal ml-2 text-gray-500">
              first image would be the cover(maxNum = 6)
            </span>
          </p>
          <div className="flex gap-4">
            ...
            <button
              ...
              className="p-3 text-blue-700 border border-blue-700 rounded uppercase hover:bg-slate-800 disabled:opacity-80"
            >
          ...
          {formData.imageUrls.length > 0 &&
            formData.imageUrls.map((url, index) => (
              <div
                key={url}
                className="flex items-center justify-between border-black p-3"
              >
                <img
                  src={url}
                  alt="property image"
                ...
                <button
                  ...
                  className="bg-red-700 rounded-lg uppercase p-2 hover:opacity-70"
                >
                  Delete
                </button>
              </div>
